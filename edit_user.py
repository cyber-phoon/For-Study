...
class Edit_Windows():
    ...
    def edit_window(self, data):
        ...
        tk.Button(edit_win, text="Сделать фотографию", command=self.process_camera_photo).grid()
        tk.Button(edit_win, text="Изменить введенное ФИО", command=lambda: self.change_data(self.entry_first_name.get(), self.entry_last_name.get(), self.entry_patronymic.get(), self.entry_new_first_name.get(), self.entry_new_last_name.get(), self.entry_new_patronymic.get())).grid()
